...
namespace WebApplicationProjetMVC.Controllers
{
    public class EntreprisesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idEntreprise,denomination,personneContact,ville,codePostal,rue,numeroRue,numTel")] Entreprise entreprise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEntreprise,denomination,personneContact,ville,codePostal,rue,numeroRue,numTel")] Entreprise entreprise)
        {
            if (ModelState.IsValid)
            {
